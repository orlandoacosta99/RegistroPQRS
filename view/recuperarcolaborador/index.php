                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="../../assets/picture/logo-sm.svg" alt="" height="28"> <span class="logo-txt">orlandoacosta99</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> orlandoacosta99 <i class="mdi mdi-heart text-danger"></i> mesadepartes.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
