...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Acceso | Registro de PQRS</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Registro de PQRS</h5>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> orlandoacosta99 <i class="mdi mdi-heart text-danger"></i> RegistroPQRS.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
